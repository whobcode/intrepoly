/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1e151891f2111ad65d2922cb4280790c)
// Runtime types generated with workerd@1.20250906.0 2025-03-07 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DEFAULT_AI_MODEL: "@cf/meta/llama-2-7b-chat-int8";
		ALLOWED_AI_MODELS: "@cf/meta/llama-2-7b-chat-int8,@cf/llama-3-8b-instruct,@cf/mistral/mistral-7b-instruct";
